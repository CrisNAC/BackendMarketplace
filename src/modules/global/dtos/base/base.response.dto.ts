...
export class PaginatedResponseDTO<T> {
  ...
  constructor(data: { content: T[]; total_elements: number; size: number; page: number }) {
  ...
  static from<T>(items: T[], totalCount: number, page: number, limit: number): PaginatedResponseDTO<T> {
